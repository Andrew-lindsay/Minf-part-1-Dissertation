...
\abstract{
The prevalence of legacy code throughout the software industry results in many costly problems in having to maintain and alter old but critical software. As programming languages evolve they introduce new features and standard library extensions that can be of benefit to old legacy code by increasing the readability of maintainability of the code. Introducing these new features into legacy code manually is a costly process in terms of developer time used and due to the chance of introducing errors into the existing code. The proposed solution featured in this report is automated source code rejuvenation, which aims to rejuvenate old code by replacing previously used idioms and workarounds with new language features that raise the level of abstraction and better express the programmers intent.

This report focuses on two areas of rejuvenation, the promotion of type inference and the transformation of for-loops to utilises a more modern loop construct. The implementation of the two source code rejuvenation tools, \textit{auto-rejuvenation} and \textit{for-loop-rejuvenation}, is given along side evaluation of their effectiveness on real-world software examples. The rejuvenation tools are also contrasted with similar exiting tools, to emphasise different possible approaches to rejuvenation. In evaluating the source code rejuvenation tools, explanations for why the tools deviated from desired performance are given, along with possible solutions to improve their effectiveness.
}

\maketitle

\section*{Acknowledgements}
Firstly, I would like to thank my supervisor Bj\"{o}rn Franke, for all his guidance and support throughout this project. His approachability and willingness to help have been indispensable. 

I would also like to thank my flatmates who were always there to remind me to take a break and relax, thanks guys.

Finally, I would like to thank my mother whose love and support at every stage has allowed me to make it this far, thank you.
\tableofcontents
...
% are differing definitions of legacy code 
...
\hline
Benchmark & File Name & Lines & \begin{tabular}[c]{@{}l@{}}For-loops\\ found\end{tabular} & \begin{tabular}[c]{@{}l@{}}\# of trans \\ Rose-tool\end{tabular} & \begin{tabular}[c]{@{}l@{}}\# of trans \\ Clang-tidy\end{tabular} \\ \hline
leela\_r & GTP & 502 & 6 & 1 & 1 \\ \hline
 & FastState & 479 & 21 & 0 & 0 \\ \hline
 & UCTSearch & 469 & 0 & 0 & 0 \\ \hline
 & UCTNode & 456 & 3 & 0 & 0 \\ \hline
 & Matcher & 100 & 3 & 0 & 0 \\ \hline
 & SGFTree & 357 & 7 & 0 & 0 \\ \hline
deepsjeng\_r & search & 1936 & 17 & 0 & 2 \\ \hline
 & utils & 1109 & 16 & 0 & 0 \\ \hline
 & pawn & 761 & 1 & 0 & 0 \\ \hline
 & bitboard & 547 & 34 & 0 & 0 \\ \hline
 & epd & 477 & 3 & 0 & 0 \\ \hline
 & ttable & 278 & 5 & 0 & 0 \\ \hline
 & moves & 227 & 18 & 0 & 0 \\ \hline
xalancbmk\_r & TraverseSchema & 9060 & 39 & 0 & 0 \\ \hline
 & SGXMLScanner & 4752 & 10 & 0 & 0 \\ \hline
 & IGXMLScanner & 3296 & 5 & 0 & 0 \\ \hline
 & DGXMLScanner & 3245 & 4 & 0 & 0 \\ \hline
 & IGXMLScanner2 & 3240 & 8 & 0 & 0 \\ \hline
 & XMLUri & 2569 & 6 & 0 & 0 \\ \hline
 & XTemplateSerializer & 2383 & 43 & 0 & 0 \\ \hline
 & SchemaValidator & 2195 & 16 & 0 & 0 \\ \hline
%  & WFXMLScanner & 2150 & 5 & 0 & 0 \\ \hline
...
% \hline
% Benchmark & File Name & Lines & \begin{tabular}[c]{@{}l@{}}for-loops \\ found\end{tabular} & \begin{tabular}[c]{@{}l@{}}\# of trans \\ Rose-tool\end{tabular} & \begin{tabular}[c]{@{}l@{}}\# of trans\\  Clang-tidy\end{tabular} \\ \hline
% leela\_r & FastBoard & 2452 & 85 & 3 & 2 \\ \hline
%  & GTP & 502 & 6 & 1 & 1 \\ \hline
%  & FastState & 479 & 21 & 0 & 0 \\ \hline
%  & UCTSearch & 469 & 0 & 0 & 0 \\ \hline
%  & UCTNode & 456 & 3 & 0 & 0 \\ \hline
...
A reason for the reduced transformation rate in the \textit{for-loop-rejuvenation} can be found in inspecting the for-loops in the files that are not being transformed, Table~\ref{tab:res-for-loop-fail}. The file \textit{bitboard.cpp} in the \textit{deepsjeng} benchmark had a large number of for loop, 34, but a zero transformation rate, an example of one of its for loops is shown in Figure \ref{fig:code-untrans-example}. The example shows that it is impossible for the transformation to proceed as the loop does not have a single array as its focus but two. The \textit{bitboard} file faces this problem as nearly all its for-loops need to access multiple arrays of type \texttt{BITBOARD} to calculate results.

\begin{table}[H]
\centering
\begin{tabular}{|l|l|}
\hline
\textbf{Reason loop not transformed} & \textbf{Number of loops} \\ \hline
Containers index \textgreater 1 & 1 \\ \hline
Comparison of size not direct & 19 \\ \hline
\begin{tabular}[c]{@{}l@{}}Size of array, passed\\  as  function argument\end{tabular} & 1 \\ \hline
Other: unsafe loop body & 2 \\ \hline
Other: loop header invalidation & 16 \\ \hline
\end{tabular}
\caption{Reason why for-loops were not transformed for the leela\_r benchmark files}
\label{tab:res-for-loop-fail}
\end{table}

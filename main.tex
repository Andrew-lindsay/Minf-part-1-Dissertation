...
In the evaluation of the source code rejuvenation additional extensions where given to the both the \textit{auto-rejuvenation} and  \textit{for-loop-rejuvenation}. It was suggested that the \textit{auto-rejuvenation} which was previously restricted to using \texttt{auto} on variable declarations only be allowed to use \texttt{auto} for the return type of the function declarations.
